...
<iframe 
  src=" https://roxanar1.github.io/portfolio-revealjs-presentation/" 
  width="100%" 
  height="600px" 
  style="border:none;">
</iframe>
...
These GA4 reports are from this portfolio website, they show very low traffic over the month of April and early May, with a total of 2 users coming from referral sources. Activity is also minimal with just a couple of spikes on specific days and no returning users or conversions recorded.

Engagement is quite low, averaging about 11 seconds per user, and while there were 30 events tracked, none of them led to key events or meaningful actions. These findings suggest the website is still in its early stage, with limited traffic, and little evidence of deeper user interaction so far.